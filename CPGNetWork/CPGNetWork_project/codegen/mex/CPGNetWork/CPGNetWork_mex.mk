START_DIR = E:\folder\»úÆ÷ÈË¶Ó\MAT\CPGNET~1

MATLAB_ROOT = D:\MATLAB~1
MAKEFILE = CPGNetWork_mex.mk

include CPGNetWork_mex.mki
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\CPGNetWork"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\CPGNetWork/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
